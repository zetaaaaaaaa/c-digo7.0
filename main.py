...
def onmessage(update,bot:ObigramClient):
    try:
        ...
        if '/start' in msgText:
            start_msg = 'Bot          : Descargador Gratis propiedad del Jaguar\n'
            print('Descargador Gratis propiedad del Jaguar')
...
def main():
    ...
    bot_token = '5362357851:AAFc_nxM6JPPmR8nZNtea-qXEXvICKYYQyM'
